            ...
            if(isset($_POST['intership'])){
             ...
             $college=$_POST['college'];
              ...
              $pno = (double)$spno;
                ...
                $query = "INSERT INTO `iprojectregister`(`pname`,`college`,`course`,`branch`,`sname`,`smail`,`spno`,`training_id`,is_value)VALUES('$pname','$college','$course','$branch','$sname','$smail','$spno','$id',1)";
