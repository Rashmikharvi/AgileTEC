...
<?php
    $id = $_GET['id'];
    $result = mysqli_query($con,"SELECT * FROM `internship program` WHERE `id`='$id'");
  ...
  <div class="container">
            <div class="container" style="background-color: #fff;">
                <div class="p-3 my-5">
                    ...
                    <div class="mb-3">
                        <h1 style="color:#005A9C;"><?php echo $row['iname']; ?></h1>
                    </div>
                    <div class="mb-5">
                        ...
                        <div class="col-md-6 mb-5">
                            <div class="card border-light">
                                <div class="card-body bg-light">
                                    <div>
                                        <h5 class="mb-3">
                                            Are you looking for Best <?php echo $row['iname']; ?> Course in Mangalore ?
                                        </h5>
                                        <p style="text-align:justify;">
                                            Our <mark>AgileTEC</mark> will ensure you to understand the terminologies that the <?php echo $row['iname']; ?> Course will encompass in it.
                                        </p>
                                        <p style="text-align:justify;">
                                            The place where you have landed is an epitome of excellence in teaching and practicing <?php echo $row['iname']; ?> concepts.
                                        </p>
                                    </div> 
                                </div>
                            </div>
