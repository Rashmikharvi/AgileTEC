                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT * FROM `iprojectregister`";
                        ...
                        <tr>
                           ...
                           <td><?php echo $row['branch']; ?></td>
                            ...
                            <td>
                                <form action="ieeprojectRegdb.php?id=<?php echo $row['id']; ?>" method="POST">
...
<?php
    if(isset($_POST['delete'])){
        $id = $_GET['id'];
        $delete = mysqli_query($con, "DELETE FROM `iprojectregister` WHERE `id`='$id'");

        if($delete){
        header("location: ieeprojectRegdb.php");
        }
    }
?>