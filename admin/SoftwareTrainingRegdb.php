                ...
                <div class="mb-5">
                    ...
                    <tbody>
                        <?php
                             ...
                             $query = "SELECT register.id,register.name,register.email,register.pnum,register.is_contacted,softwaretraining.service_name
                                 FROM register,softwaretraining
                                 WHERE softwaretraining.id=register.service_id";
