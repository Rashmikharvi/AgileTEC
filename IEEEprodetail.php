...
<?php
    $id = $_GET['id'];
    $result = mysqli_query($con,"SELECT * FROM `ieee projectguide` WHERE `id`='$id'");
...
<?php require("nav.php");?>
  <div class="container">
            <div class="container" style="background-color: #fff;">
                <div class="p-3 my-5">
                    <div class="mb-5">
                        <img src="img/<?php echo $row['pimg']; ?>" style="border: solid #000;width: 100%;" />
                    </div>
                    <div class="mb-3">
                        <h1 style="color:#005A9C;"><?php echo $row['pname']; ?></h1>
                    </div>
                    <div class="mb-5">
                        ...
                        <div class="col-md-6 mb-5">
                            <div class="card border-light">
                                <div class="card-body bg-light">
                                    <div>
                                        <h5 class="mb-3">
                                            Are you looking for Best <?php echo $row['pname']; ?> Course in Mangalore ?
                                        </h5>
                                        <p style="text-align:justify;">
                                            Our <mark>AgileTEC</mark> will ensure you to understand the terminologies that the <?php echo $row['pname']; ?> Course will encompass in it.
                                        </p>
                                        <p style="text-align:justify;">
                                            The place where you have landed is an epitome of excellence in teaching and practicing <?php echo $row['pname']; ?> concepts.
                                        </p>
                                    </div> 
                                </div>
                            </div>
